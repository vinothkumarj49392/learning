                        ...
                        <article class="course-detail">
                            <section id="course-header">
                                <header>
                                    ...
                                    <span class="pull-right course-joined"><i class="fa fa-check-circle-o"></i>Joined!</span>
                                    <div class="course-category">Type:<a href="#">Marketing</a></div>
                                </header>
                                <hr>
                            ...
                            <section class="course-schedule">
                                <header><h2>Course Schedule</h2></header>
                                <article class="course-schedule-block course-completed">
                                    <header><h4>Week 1:</h4></header>
                                    <figure class="course-completed-tag"><i class="fa fa-check"></i>Completed</figure>
                            ...
                            <section id="join-to-course" class="center">
                                <a href="register-sign-in.html" class="btn" id="btn-course-join-bottom">Join Course</a>
