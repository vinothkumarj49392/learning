...
<body class="page-homepage-events">
<!-- Wrapper -->
<div class="wrapper">
<!-- Header -->
            ...
            <li class="slide">
                <figure>
                    <div class="slide-wrapper">
                        <div class="inner">
                            <div class="container">
                                <h2>Electronic Music Show</h2>
                                <h1>DJ Tom F Live!</h1>
                                <div><a href="event-detail.html" class="btn">View Event</a></div>
                            </div>
                        </div><!-- /.inner -->
                    </div><!-- /.wrapper -->
                </figure>
                <img src="assets/img/event-slide-01.jpg">
            </li>
            <li class="slide">
                <figure>
                    <div class="slide-wrapper">
                ...
                <img src="assets/img/slider-slide-02.jpg">
            </li>
        </ul>
    </div>
</section>
...
<div id="page-content">
    <section id="featured-courses">
        <div class="block">
            <div class="container">
                <header><h2>Recommended Events</h2></header>
                <div class="row">
            ...
            <div class="col-md-8">
                <div id="page-main">
                    <section class="events images" id="events">
                        <header><h2>Today Events</h2></header>
            ...
            <div class="col-md-4">
                <div id="page-sidebar" class="sidebar">
                    ...
                    <aside id="video">
                        <header>
                            <h2>Video Event</h2>
                            <iframe width="100%" height="315" src="//www.youtube.com/embed/T4nLjWqfiZ4" frameborder="0" allowfullscreen></iframe>
                        </header>
                    </aside>
                </div><!-- /#sidebar -->
            </div><!-- /.col-md-4 -->
