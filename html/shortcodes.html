...
<body class="page-sub-page page-shortcodes">
<!-- Wrapper -->
<div class="wrapper">
<!-- Header -->
                    ...
                    <section id="shortcodes">
                        ...
                        <article>
                            <p>
                                ...
                                vehicula eget ligula et, malesuada pharetra est.
                            </p>
                        </article>
                        ...
                        <article>
                            <section id="course-tabs">
                                ...
                                <ul class="nav nav-tabs course-detail-tabs">
                                    <li class="active"><a href="#tab-a" data-toggle="tab">Tab A</a></li>
                                    <li><a href="#tab-b" data-toggle="tab">Tab B</a></li>
                                    <li><a href="#tab-c" data-toggle="tab">Tab C</a></li>
                                </ul><!-- /.course-detail-tabs -->

                                <!-- Tab panes -->
                                <div class="tab-content course-tab-content">
                                    <div class="tab-pane fade in active" id="tab-a">
                                        <section><strong>Tab A content</strong></section>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <article>
                                    <p><a href="" class="btn btn-small">Default Button</a></p>
                                    <p><a href="" class="btn">Default Button</a></p>
                                    <p><a href="" class="btn btn-large">Default Button</a></p>
                                    <br>
                                    <p><a href="" class="btn btn-color-primary btn-small">Button Primary Color</a></p>
                                    <p><a href="" class="btn btn-color-primary">Button Primary Color</a></p>
                                    <p><a href="" class="btn btn-color-primary btn-large">Button Primary Color</a></p>
                                    <br>
                                    <p><a href="" class="btn btn-color-grey-dark btn-small">Button Grey Dark Color</a></p>
                                    <p><a href="" class="btn btn-color-grey-dark">Button Grey Dark Color</a></p>
                                    <p><a href="" class="btn btn-color-grey-dark btn-large">Button Grey Dark Color</a></p>
                                    <br>
                                    <p><a href="" class="btn btn-color-grey-light btn-small">Button Grey Light Color</a></p>
                                    <p><a href="" class="btn btn-color-grey-light">Button Grey Light Color</a></p>
                                    <p><a href="" class="btn btn-color-grey-light btn-large">Button Grey Light Color</a></p>
                                </article>
                            </div>
                            <div class="col-md-6">
                                <article>
                                    <p><a href="" class="btn btn-framed btn-small">Default Button</a></p>
                                    <p><a href="" class="btn btn-framed">Default Button</a></p>
                                    <p><a href="" class="btn btn-framed btn-large">Default Button</a></p>
                                    <br>
                                    <p><a href="" class="btn btn-framed btn-color-primary btn-small">Button Primary Color</a></p>
                                    <p><a href="" class="btn btn-framed btn-color-primary">Button Primary Color</a></p>
                                    <p><a href="" class="btn btn-framed btn-color-primary btn-large">Button Primary Color</a></p>
                                    <br>
                                    <p><a href="" class="btn btn-framed btn-color-grey-dark btn-small">Button Grey Dark Color</a></p>
                                    <p><a href="" class="btn btn-framed btn-color-grey-dark">Button Grey Dark Color</a></p>
                                    <p><a href="" class="btn btn-framed btn-color-grey-dark btn-large">Button Grey Dark Color</a></p>
                                    <br>
                                    <p><a href="" class="btn btn-framed btn-color-grey-light btn-small">Button Grey Light Color</a></p>
                                    <p><a href="" class="btn btn-framed btn-color-grey-light">Button Grey Light Color</a></p>
                                    <p><a href="" class="btn btn-framed btn-color-grey-light btn-large">Button Grey Light Color</a></p>
                                </article>
                            </div>
                        </div>
