...
<body class="page-sub-page page-course-listing-images">
<!-- Wrapper -->
<div class="wrapper">
<!-- Header -->
                    ...
                    <section class="course-listing" id="courses">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <article class="course-thumbnail">
                                    <figure class="image">
                                        <div class="image-wrapper"><a href="course-detail-v1.html"><img src="assets/img/event-img-03.jpg"></a></div>
                                    </figure>
                                    <div class="description">
                                        <a href="course-detail-v1.html"><h3>How to find long term customers</h3></a>
                                        <a href="#" class="course-category">Marketing</a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <article class="course-thumbnail">
                                    <figure class="image">
                                        <div class="image-wrapper"><a href="course-detail-v1.html"><img src="assets/img/event-img-04.jpg"></a></div>
                                    </figure>
                                    <div class="description">
                                        <a href="course-detail-v1.html"><h3>Character Drawing: Basic and Advanced Principles</h3></a>
                                        <a href="#" class="course-category">Art and Design</a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <article class="course-thumbnail">
                                    <figure class="image">
                                        <div class="image-wrapper"><a href="course-detail-v1.html"><img src="assets/img/event-img-05.jpg"></a></div>
                                    </figure>
                                    <div class="description">
                                        <a href="course-detail-v1.html"><h3>Architecture Photography: Power of Light and Shadows</h3></a>
                                        <a href="#" class="course-category">Photography</a>
